...
export const inputStyles = tv({
  slots: {
    inputGroup:
      'border dark:border-gray-600 rounded-lg flex items-center h-12 mt-1 text-gray-800 dark:text-white transition-colors duration-150 ease-in-out',
    input:
      'bg-transparent flex-grow text-sm mx-3 my-2 focus:outline-none autofill:bg-transparent autofill:filter-none autofill:shadow-none',
